...
# Function to create a VTK example with a cube
def create_vtk_cube_example():
    # Create a cube source object
    cubeSource = vtk.vtkCubeSource()

    # Create a mapper object to map the cube data to graphics primitives
    mapper = vtk.vtkPolyDataMapper()
    # Connect the mapper to the output of the cube source
    mapper.SetInputConnection(cubeSource.GetOutputPort())

    # Create an actor object to represent the cube in the scene
    actor = vtk.vtkActor()
